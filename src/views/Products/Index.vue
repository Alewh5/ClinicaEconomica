                    ...
                    <tbody class="bg-white">
                        <tr v-for="(product, index) in products" :key="product.id">
                            ...
                            <td class="px-6 py-2 border-b border-gray-200 whitespace-nowrap">
                                ...
                                <div class="text-sm leading-5 text-gray-900">
                                    <span class="font-semibold">IVA:</span> {{ product.iva_venta }}%
                                </div>
                            </td>
                            <td class="px-6 py-2 border-b border-gray-200 whitespace-nowrap">
                                <div class="text-sm leading-5 text-gray-900">
                                ...
                                <div class="text-sm leading-5 text-gray-900">
                                    <span class="font-semibold">CATEGORIA:</span> {{ product.categoria }}
                                </div>
                            </td>
                            <td class="px-6 py-2 border-b border-gray-200 whitespace-nowrap text-center">

                                <div class="text-sm leading-5 text-gray-900"> {{ product.Cantidad_Total }}
                                </div>
                            </td>
                            <td class="px-6 py-4 border-b border-gray-200 whitespace-nowrap text-center">
                                <span :class="{
                                    'inline-flex px-2 capitalize text-xs font-semibold leading-5 rounded-full': true,
                                    'bg-green-100 text-green-800': product.estado === 'activo',
                                    'bg-red-100 text-red-800': product.estado !== 'activo'
                                }">
                                    {{ product.estado }}
                                </span>
                            </td>
                            <td class="px-6 py-2 border-b border-gray-200 whitespace-nowrap text-center">
                                <div class="flex items-center justify-center">
                                    ...
                                    <a @click="deleteItem(product.id, product.descripcion)"
...
const deleteItem = async (id, name) => {
    confirmation(name, ('/products/' + id), '/products');
}
