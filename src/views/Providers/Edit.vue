        ...
        <div class="px-4 pb-8 pt-5 bg-white shadow-md">
            <form>
                <div class="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
                    <div>
                        <label class="text-gray-700" for="tipoDocumento">Tipo Documento <span v-if="formErrors['tipoDocumento']" class="text-red-500 mt-1 text-sm">*</span></label>
                        <div class="flex mt-2">
                            <div
                            ...
                            <select class="w-full bg-white rounded-r-md pl-2 text-base font-regular outline-0" :class="{ 'border-red-500 border-2': formErrors['tipoDocumento'] }"
                                id="tipoDocumento" v-model="form.tipoDocumento">
                    ...
                    <div>
                        <label class="text-gray-700" for="numeroDocumento">Número Documento <span v-if="formErrors['numeroDocumento']" class="text-red-500 mt-1 text-sm">*</span></label>
                        <div class="flex mt-2">
                            <div
                                class="flex items-center justify-center rounded-tl-lg rounded-bl-lg border-y border-l relative border-gray-400 bg-white p-5">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                    ...
                    <div>
                        <label class="text-gray-700" for="NombreRazonSocial">Nombre / Razón Social <span v-if="formErrors['NombreRazonSocial']" class="text-red-500 mt-1 text-sm">*</span></label>
                        <div class="flex mt-2">
                            <div
                                class="flex items-center justify-center rounded-tl-lg rounded-bl-lg border-y border-l relative border-gray-400 bg-white p-5">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                            ...
                            <input type="text" class="w-full bg-white rounded-r-md pl-2 text-base font-regular outline-0" :class="{ 'border-red-500 border-2': formErrors['NombreRazonSocial'] }"
                                id="NombreRazonSocial" v-model="form.NombreRazonSocial" autocomplete="off">
                        </div>
                    </div>

                    <div>
                        <label class="text-gray-700" for="email">Correo Electronico <span v-if="formErrors['email']" class="text-red-500 mt-1 text-sm">*</span></label>
                        <div class="flex mt-2">
                            <div
                                class="flex items-center justify-center rounded-tl-lg rounded-bl-lg border-y border-l relative border-gray-400 bg-white p-5">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                            ...
                            <input type="email" class="w-full bg-white rounded-r-md pl-2 text-base font-regular outline-0" :class="{ 'border-red-500 border-2': formErrors['email'] }"
                                id="email" v-model="form.email" autocomplete="off">
                        </div>
                    </div>

                    <div>
                        <label class="text-gray-700" for="telefono">Teléfono <span v-if="formErrors['telefono']" class="text-red-500 mt-1 text-sm">*</span></label>
                        <div class="flex mt-2">
                            <div
                                class="flex items-center justify-center rounded-tl-lg rounded-bl-lg border-y border-l relative border-gray-400 bg-white p-5">
                            ...
                            <input type="text" class="w-full bg-white rounded-r-md pl-2 text-base font-regular outline-0" :class="{ 'border-red-500 border-2': formErrors['telefono'] }"
                                id="telefono" v-model="form.telefono" autocomplete="off">
                        </div>
                    </div>

                    <div>
                        <label class="text-gray-700" for="direccion">Dirección <span v-if="formErrors['direccion']" class="text-red-500 mt-1 text-sm">*</span></label>
                        <div class="flex mt-2">
                            <div
                                class="flex items-center justify-center rounded-tl-lg rounded-bl-lg border-y border-l relative border-gray-400 bg-white p-5">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                            ...
                            <input type="text" class="w-full bg-white rounded-r-md pl-2 text-base font-regular outline-0" :class="{ 'border-red-500 border-2': formErrors['direccion'] }"
                                id="direccion" v-model="form.direccion" autocomplete="off">
                        </div>
                    </div>

                    <div>
                        <label class="text-gray-700" for="municipio">Municipio <span v-if="formErrors['municipio']" class="text-red-500 mt-1 text-sm">*</span></label>
                        <div class="flex mt-2">
                            <div
                                class="flex items-center justify-center rounded-tl-lg rounded-bl-lg border-y border-l relative border-gray-400 bg-white p-5">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                            ...
                            <input type="text" class="w-full bg-white rounded-r-md pl-2 text-base font-regular outline-0" :class="{ 'border-red-500 border-2': formErrors['municipio'] }"
                                id="municipio" v-model="form.municipio">
                        </div>
                    </div>

                    <div>
                        <label class="text-gray-700" for="departamento">Departamento <span v-if="formErrors['departamento']" class="text-red-500 mt-1 text-sm">*</span></label>
                        <div class="flex mt-2">
                            <div
                                class="flex items-center justify-center rounded-tl-lg rounded-bl-lg border-y border-l relative border-gray-400 bg-white p-5">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                            ...
                            <input type="text" class="w-full bg-white rounded-r-md pl-2 text-base font-regular outline-0" :class="{ 'border-red-500 border-2': formErrors['departamento'] }"
                                id="departamento" v-model="form.departamento">
                        </div>
                    </div>
...
const getProviders = () => {
    axios.get('/providers/' + id.value).then(
...
const save = async () => {
    const { status, list_errors } = await sendRequest('PUT', form.value, '/providers/' + id.value, '/providers');
    if (status == 422) {
