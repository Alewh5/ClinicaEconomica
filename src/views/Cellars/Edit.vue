        ...
        <div class="px-4 pb-8 pt-5 bg-white shadow-md">
            <form>
                <div class="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
                    ...
                    <div>
                        <label class="text-gray-700" for="nombre">Nombre de la Bodega <span v-if="formErrors['nombre']"
                    ...
                    <div>
                        <label class="text-gray-700" for="ubicacion">Ubicación <span v-if="formErrors['ubicacion']"
                                class="text-red-500 mt-1 text-sm">*</span></label>
                        <div class="flex mt-2">
                            <div
                                class="flex items-center justify-center rounded-tl-lg rounded-bl-lg border-y border-l relative border-gray-400 bg-white p-5">
                            ...
                            <input type="text" class="w-full bg-white rounded-r-md pl-2 text-base font-regular outline-0"
                                :class="{ 'border-red-500 border-2': formErrors['ubicacion'] }" id="ubicacion"
                                v-model="form.ubicacion" autocomplete="off">
                        </div>
                    </div>
