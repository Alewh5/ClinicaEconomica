        ...
        <div class="px-4 pb-8 pt-5 bg-white shadow-md">
            <form>
                <div class="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4">
                    ...
                    <div v-if="form.cellar">
                        <label class="text-gray-700" for="cellar_id">Bodega</label>
                        <div class="flex mt-2">
                            <div
                            ...
                            <input type="text" class="w-full bg-white rounded-r-md pl-2 text-base font-regular outline-0"
                                id="fecha" v-model="form.cellar.nombre"
                    ...
                    <div>
                        ...
                        <div class="flex mt-2">
                            ...
                            <input type="date" class="w-full bg-white rounded-r-md pl-2 text-base font-regular outline-0"
                                id="fecha" v-model="form.fecha"
                                autocomplete="off" disabled>
                        </div>
                    </div>

                    <div>
                        <label class="text-gray-700" for="tipoMovimiento">Tipo Movimiento</label>
                        <div class="flex mt-2">
                            <div
                                class="flex items-center justify-center rounded-tl-lg rounded-bl-lg border-y border-l relative border-gray-400 bg-white p-5">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                            ...
                            <select class="w-full bg-white rounded-r-md pl-2 text-base font-regular outline-0"
                                v-model="form.tipoMovimiento" disabled>
                    ...
                    <div>
                        <label class="text-gray-700" for="concepto">Concepto</label>
                        <div class="flex mt-2">
                            <div
                                class="flex items-center justify-center rounded-tl-lg rounded-bl-lg border-y border-l relative border-gray-400 bg-white p-5">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                            ...
                            <input type="text" class="w-full bg-white rounded-r-md pl-2 text-base font-regular outline-0"
                                v-model="form.concepto" autocomplete="off" disabled>
                        </div>
                    </div>
                    ...
                    <div
                        ...
                        <table class="min-w-full">
                            ...
                            <tbody class="bg-white">
                                <tr v-for="(product, index) in form.movement_product" :key="index">
                                    ...
                                    <td class="px-1 py-4 border-b border-gray-200 whitespace-nowrap text-center">
                                        <vue-number type="text"
                                            class="w-full bg-white rounded pl-2 text-base font-regular outline-0"
                                            id="costo_unitario" v-model="product.pivot.costo_unitario" autocomplete="off"
                                    ...
                                    <td class="px-1 py-4 border-b border-gray-200 whitespace-nowrap text-center">
                                        <vue-number type="text"
                                            ...
                                            id="costo_total" v-model="product.pivot.costo_total" autocomplete="off"
