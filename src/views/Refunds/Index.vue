                    ...
                    <tbody class="bg-white">
                        <tr v-for="refund in refunds" :key="refund.id">
                            <td class="px-6 py-2 border-b border-gray-200 whitespace-nowrap">
                                <span v-if="refund.sale_id" class="inline-flex px-2 capitalize text-xs font-semibold leading-5 text-green-800 bg-green-100 rounded-full">
                                    {{ refund.sale_id ? 'Devolución de Venta' : '' }}
                                </span>
                                <span v-else class="inline-flex px-2 capitalize text-xs font-semibold leading-5 text-green-800 bg-lime-100 rounded-full">
                                    {{ refund.invoice_id ? 'Devolución de Compra' : '' }}
                                </span>
                            </td>
                            <td class="px-6 py-2 border-b border-gray-200 whitespace-nowrap">
                ...
                style: 'currency', currency: 'COP'
                            ...
                            <td class="px-6 py-2 border-b border-gray-200 whitespace-nowrap text-center">
                                <div class="flex items-center justify-center">
                                    <router-link :to="{ path: 'refunds/show/' + refund.id }"
