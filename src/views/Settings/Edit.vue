        ...
        <div class="px-4 pb-8 pt-5 bg-white shadow-md">
            <form>
                <div class="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4">
                    ...
                    <div>
                        <label class="text-gray-700" for="nit">NIT <span v-if="formErrors['nit']"
                        ...
                        <div class="flex mt-2">
                            ...
                            <input type="text" class="w-full bg-white rounded-r-md pl-2 text-base font-regular outline-0"
                                :class="{ 'border-red-500 border-2': formErrors['nit'] }" id="nit"
                                v-model="form.nit" autocomplete="off">
                        </div>
                    </div>
                    
                    <div>
                        <label class="text-gray-700" for="nombre">Nombre <span v-if="formErrors['nombre']"
                                class="text-red-500 mt-1 text-sm">*</span></label>
                        <div class="flex mt-2">
                            <div
                                class="flex items-center justify-center rounded-tl-lg rounded-bl-lg border-y border-l relative border-gray-400 bg-white p-5">
                            ...
                            <input type="text" class="w-full bg-white rounded-r-md pl-2 text-base font-regular outline-0"
                                :class="{ 'border-red-500 border-2': formErrors['nombre'] }" id="nombre"
                                v-model="form.nombre" autocomplete="off">
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="flex mt-2">
                            ...
                            <input type="text" class="w-full bg-white rounded-r-md pl-2 text-base font-regular outline-0"
                                :class="{ 'border-red-500 border-2': formErrors['email'] }" id="email"
                                v-model="form.email" autocomplete="off">
                        </div>
                    </div>

                    <div>
                        <label class="text-gray-700" for="email">Sitio Web <span v-if="formErrors['email']"
                                class="text-red-500 mt-1 text-sm">*</span></label>
                        <div class="flex mt-2">
                            <div
                                class="flex items-center justify-center rounded-tl-lg rounded-bl-lg border-y border-l relative border-gray-400 bg-white p-5">
                    ...
                    <div>
                        ...
                        <div class="flex mt-2">
                            ...
                            <input type="text" class="w-full bg-white rounded-r-md pl-2 text-base font-regular outline-0"
                                ...
                                v-model="form.municipio" autocomplete="off">
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="flex mt-2">
                            ...
                            <input type="text" class="w-full bg-white rounded-r-md pl-2 text-base font-regular outline-0"
                                ...
                                v-model="form.departamento" autocomplete="off">
                        </div>
                    </div>

                    <div>
                        <label class="text-gray-700" for="codigo_postal">Código Postal <span v-if="formErrors['codigo_postal']"
                                class="text-red-500 mt-1 text-sm">*</span></label>
                        <div class="flex mt-2">
                            <div
                                class="flex items-center justify-center rounded-tl-lg rounded-bl-lg border-y border-l relative border-gray-400 bg-white p-5">
                            ...
                            <input type="text" class="w-full bg-white rounded-r-md pl-2 text-base font-regular outline-0"
                                :class="{ 'border-red-500 border-2': formErrors['codigo_postal'] }" id="codigo_postal"
                                v-model="form.codigo_postal" autocomplete="off">
                        </div>
                    </div>
