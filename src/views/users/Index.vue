<template>
    ...
    <div class="flex justify-between items-center flex-row">
            ...
            <div class="flex">
                <div class="relative mr-2">
                    <select v-model="perPage" @change="loadData(1)"
                        class="block sm:w-full w-100% px-3 pr-8 py-1 leading-tight text-gray-700 bg-white border border-gray-400 rounded appearance-none focus:outline-none focus:bg-white focus:border-gray-500">
        ...
        <router-link
            class="inline-flex items-center px-2 py-1 ml-2 bg-blue-600 transition ease-in-out delay-75 hover:bg-blue-700 text-white text-sm font-medium rounded-md"
            to="/users/create">
        ...
        <div class="py-2 overflow-x-auto overflow-y-auto sm:-mx-6 sm:px-6 lg:-mx-8 lg:px-8">
            <div class="inline-block min-w-full overflow-hidden align-middle border-b border-gray-200 shadow rounded">
                <table class="min-w-full">
                    <thead>
                        <tr>
                            <th class="px-6 py-2 text-xs font-bold leading-4 tracking-wider text-left text-white uppercase bg-gray-900 border-b border-gray-200">
                                Nombre
                            </th>
                            <th class="px-6 py-2 text-xs font-bold leading-4 tracking-wider text-left text-white uppercase bg-gray-900 border-b border-gray-200">
                                correo
                            ...
                            <th class="px-6 py-2 text-xs font-bold leading-4 tracking-wider text-center text-white uppercase bg-gray-900 border-b border-gray-200">
                                Acciones
                            </th>
                        </tr>
                    </thead>
                        ...
                        <tr v-for="user in users" :key="user.id">
                            ...
                            <td class="px-6 py-2 border-b border-gray-200 whitespace-nowrap text-center">
                                <div class="flex items-center justify-center">
                                    ...
                                    <a @click="deleteUser(user.id, user.nombre)"
...
const deleteUser = async (id, name) => {
    confirmation(name, `/users/${id}`, '', async () => {
        await loadData(1);
    });
}
