    ...
    <div :class="isOpen ? 'translate-x-0 ease-out' : '-translate-x-full ease-in'"
      ...
      <div class="flex items-center justify-center mt-8">
        <div class="flex items-center">
          <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="bi bi-qr-code-scan w-5 h-5 text-white"
            viewBox="0 0 16 16">
            <path
      ...
      <nav class="mt-10">
        ...
        <router-link class="flex items-center px-6 py-2 duration-200 border-l-4"
          :class="[($route.name === 'Customers' || $route.name === 'Customers-Create' || $route.name === 'Customers-Edit') ? activeClass : inactiveClass]"
          to="/customers">
        ...
        <router-link class="flex items-center px-6 py-2 mt-1 duration-200 border-l-4"
          :class="[($route.name === 'Providers' || $route.name === 'Providers-Create' || $route.name === 'Providers-Edit') ? activeClass : inactiveClass]"
          to="/providers">
          <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-building-add"
            viewBox="0 0 16 16">
            <path
        ...
        <router-link class="flex items-center px-6 py-2 duration-200 border-l-4"
          :class="[($route.name === 'Cellars' || $route.name === 'Cellars-Create' || $route.name === 'Cellars-Edit') ? activeClass : inactiveClass]"
          to="/cellars">
          <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-houses-fill"
            viewBox="0 0 16 16">
            <path
          ...
          <span class="mx-4">Bodegas</span>
        </router-link>

        <router-link class="flex items-center mt-1 px-6 py-2 duration-200 border-l-4"
          :class="[($route.name === 'Products' || $route.name === 'Products-Create' || $route.name === 'Products-Edit') ? activeClass : inactiveClass]"
          to="/products">
        ...
        <router-link class="flex items-center mt-1 px-6 py-2 duration-200 border-l-4"
          :class="[($route.name === 'Invoices' || $route.name === 'Invoices-Create' || $route.name === 'Invoices-Show') ? activeClass : inactiveClass]"
          to="/invoices">
          ...
          <span class="mx-4">Comprar</span>
        </router-link>

        <router-link class="flex items-center px-6 py-2 mt-1 duration-200 border-l-4"
          :class="[($route.name === 'Sales' || $route.name === 'Sales-Create' || $route.name === 'Sales-Show') ? activeClass : inactiveClass]"
          to="/sales/create">
